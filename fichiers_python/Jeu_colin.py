...
class Jeux():
    def __init__(self, couleur, titre):
        ...
        # Bouton Quitter
        self.bouton_quitter_rect = pygame.Rect(largeur - 110, 10, 100, 40)  
        self.bouton_quitter_couleur = red  
        self.bouton_quitter_texte = "Quitter"  
    ...
    def afficher_touches(self):
        ...
        touches_enfoncees = pygame.key.get_pressed()
        souris_enfoncee = pygame.mouse.get_pressed()
        ...
        # La largeur rectangle est la plus grande des deux largeurs
        rect_width = max(max_touche_width, max_action_width) + 40  
        ...
        for i, (touche, action) in enumerate(touches_ligne1):
            ...
            # Définir couleur ectangle en fonction de la touche enfoncée
            if (touche == "Z" and touches_enfoncees[pygame.K_z]) or \
            (touche == "Q" and touches_enfoncees[pygame.K_q]) or \
            (touche == "S" and touches_enfoncees[pygame.K_s]) or \
            (touche == "D" and touches_enfoncees[pygame.K_d]) or \
            (touche == "E" and touches_enfoncees[pygame.K_e]) or \
            (touche == "A" and touches_enfoncees[pygame.K_a]) or \
            (touche == "F" and touches_enfoncees[pygame.K_f]) or \
            (touche == "Shift" and touches_enfoncees[pygame.K_LSHIFT]) or \
            (touche == "Espace" and touches_enfoncees[pygame.K_SPACE]) or \
            (touche == "Clic G" and souris_enfoncee[0]) or \
            (touche == "Clic D" and souris_enfoncee[2]):
                couleur_rect = green  
            else:
                couleur_rect = blue  
            ...
            fond = pygame.Surface((rect_width, rect_height))
            fond.fill((30, 30, 30))  
            pygame.draw.rect(fond, couleur_rect, (0, 0, rect_width, rect_height), 3)  
            self.fenetre.blit(fond, (rect_x, rect_y))
